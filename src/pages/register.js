            ...
            <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
                ...
                <form class="p-12 md:p-24">
                    <div class="flex items-center text-lg mb-6 md:mb-8">
                        ...
                        <input type="text" id="username" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="Username" onChange={handleUsernameChange} />
                    </div>
                    <div class="flex items-center text-lg mb-6 md:mb-8">
                        <svg class="absolute ml-3" width="24" viewBox="0 0 24 24">
                    ...
                    <button onClick={handleSubmit} class="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full">Signup</button>
                    <div class="mt-6 text-blue-500 text-center">
                        <a href="/login" class="hover:underline">Already have account</a>
                    </div>
                </form>
            </div>
        </div>
